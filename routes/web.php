...
Route::post('/cart/updateQuantityCheckout', 'CartController@updateQuantityCheckout')->name('cart.updateQuantityChekout');
...
Route::post('pincode/check', 'HomeController@CheckPincode')->name('pincode.check');
