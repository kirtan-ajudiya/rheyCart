    ...
    <div class="section first-section"
        ...
        <div class="row">
            <div class="col lg-12 page-title">
              <h1 class="text-white margin-bottom text-uppercase text-center">Terms and Conditions</h1>
              <div class="text-small text-align-center"><a href="{{route('home')}}" class="on-dark">Home</a> / <span class="low-text-contrast text-white">Terms and Conditions</span></div>
            </div>
        </div>
    </div>
    ...
    <div class="col lg-9 md-12 no-margin-bottom padding-top-bottom-double bg-white">
        <div class="privacy-policy-text margin-bottom">
            ...
            <p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on
                behalf of an entity (“you”) and Rhey Cart ("<strong>Company</strong>", “<strong>we</strong>",
                “<strong>us</strong>", or “<strong>our</strong>”), concerning your access to and use of the <a
                    href="https://rheycart.com/" class="animation-underline-link" target="_blank">Rhey Cart</a> website
                as well as any other media form, media channel, mobile website or mobile application related, linked, or
                otherwise connected thereto (collectively, the “Site”). We are registered in India and have our
                registered office at Plot No.204 Usha Nagar Soc, Beside Millennium 4 Market Siddhivinayak Road Bhatena
                Surat, Gujarat 395007. You agree that by accessing the Site, you have read, understood, and agreed to be
            ...
            <p>If you provide any information that is untrue, inaccurate, not current, or incomplete, we have the right
            ...
            <p>The Site does not offer users to submit or post content. We may provide you with the opportunity to
                ...
                Policy. When you create or make available any Contributions, you thereby represent and warrant that:</p>
            <ul class="inline-ul">
                ...
                <li>You are the creator and owner of or have the necessary licenses, rights, consents, releases, and
                    ...
                    Contributions in any manner contemplated by the Site and these Terms of Use.</li>
            ...
            <p>Any use of the Site in violation of the foregoing violates these Terms of Use and may result in, among
                other things, termination or suspension of your rights to use the Site.</p>
            <p><b>CONTRIBUTION LICENSE</b></p>
            <p>You and the Site agree that we may access, store, process, and use any information and personal data that
            ...
            <p>We may provide you areas on the Site to leave reviews or ratings. When posting a review, you must comply
                ...
                post reviews, whether positive or negative.</p>
            ...
            <p>We care about data privacy and security. Please review our Privacy Policy: <a
                    href="https://rheycart.com/privacy-policy" class="animation-underline-link" target="_blank">Privacy
                    Policy</a> By using the Site, you agree to be bound by our Privacy Policy, which is incorporated
                into these Terms of Use. Please be advised the Site is hosted in India. If you access the Site from any
                other region of the world with laws or other requirements governing personal data collection, use, or
                disclosure that differ from applicable laws in India, then through your continued use of the Site, you
                are transferring your data to India, and you agree to have your data transferred to and processed in
                India.</p>
            ...
            <p>If we terminate or suspend your account for any reason, you are prohibited from registering and creating
            ...
            <p>These Terms shall be governed by and defined following the laws of India. Rhey Cart and yourself
            ...
            <p>You agree to irrevocably submit all disputes related to Terms or the relationship established by this
                Agreement to the jurisdiction of the India courts. Rhey Cart shall also maintain the right to bring
            ...
            <div>
                <ul class="no-margin-trbl no-padding-trbl">
                    <li class="d-flex mb-10"> <span><i class="fa margin-right icon"
                                ...
                                target="_blank" class="low-text-contrast">Plot No.204 Usha Nagar Soc, Beside Millennium
                                4 Market Siddhivinayak Road Bhatena, Surat-395007, Gujarat, India</a></span></li>
                    <li class="d-flex mb-10"> <span><i class="fa margin-right icon"
                                style="font-size: 25px;"></i></span> <span><a href="tel:+919033900526"
                                class="low-text-contrast">+91 90339 00526</a>, <a href="tel:+919313512128"
                                class="low-text-contrast">+91 93135 12128</a></span></li>
                    <li class="d-flex mb-10"> <span><i class="fab fa-whatsapp margin-right"
                                style="font-size: 25px;"></i></span> <span><a href="https://wa.me/+919033900526"
                                target="_blank" class="low-text-contrast">+91 90339 00526</a>, <a
                                href="https://wa.me/+919313512128" target="_blank" class="low-text-contrast">+91 93135
                                12128</a></span></li>
                    <li class="d-flex mb-10"> <span><i class="fa margin-right icon"
                                style="font-size: 25px;"></i></span> <span><a href="mailto:info@rheycart.com"
                                class="low-text-contrast">info@rheycart.com</a></span></li>
                </ul>
            </div>
