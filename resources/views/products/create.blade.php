				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="sku_code" placeholder="{{__('SKU Code')}}" required>
								</div>
							</div>
						...
						<div id="demo-stk-lft-tab-6" class="tab-pane fade">
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="number" min="0" value="0" step="0.01" placeholder="{{__('MRP')}}" name="unit_price" class="form-control" required>
								</div>
							</div>
							<div class="form-group">
						...
						<div id="demo-stk-lft-tab-11" class="tab-pane fade">
							<div class="form-group">
			                    ...
			                    <div class="col-lg-7">
									<input type="text" data-role="tagsinput" name="pincode[]" />
			                    </div>
			                </div>
				        </div>
