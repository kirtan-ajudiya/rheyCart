			...
			<div class="panel-body">
				<div class="tab-base tab-stacked-left">
				    ...
				    <ul class="nav nav-tabs">
						...
						<li class="">
				            <a data-toggle="tab" href="#demo-stk-lft-tab-11" aria-expanded="false">{{__('Pincode')}}</a>
				        </li>
				    </ul>
				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							...
							<div class="form-group">
	                            ...
	                            <div class="col-lg-7">
	                                <input type="text" class="form-control" name="sku_code" placeholder="{{__('SKU Code')}}" value="{{$product->sku_code}}" required>
	                            </div>
	                        </div>
						...
						<div id="demo-stk-lft-tab-6" class="tab-pane fade">
							<div class="form-group">
	                            ...
	                            <div class="col-lg-7">
	                                <input type="text" placeholder="{{__('MRP')}}" name="unit_price" class="form-control" value="{{$product->unit_price}}" required>
	                            </div>
	                        </div>
	                        <div class="form-group">
						...
						<div id="demo-stk-lft-tab-11" class="tab-pane fade">
							<div class="form-group">
								<div class="col-lg-2">
									<input type="text" class="form-control" value="{{__('Pincode')}}" disabled>
								</div>
			                    <div class="col-lg-7">
									<input type="text" data-role="tagsinput" name="pincode[]" value="{{ $product->pincode }}" />
			                    </div>
			                </div>
				        </div>
				    </div>
