...
@section('content')
    ...
    <div class="tab-base">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-5" aria-expanded="false">{{ __('Saree banner ') }}</a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-6" aria-expanded="false">{{ __('All Page banner') }}</a>
            </li>
            <!-- <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-5" aria-expanded="false">{{ __('Saree banner') }}</a>
            </li> -->
        ...
        <div class="tab-content">
            ...
            <div id="demo-lft-tab-5" class="tab-pane fade">
                <div class="row">
                    <div class="col-sm-12">
                        <a onclick="add_banner_7()" class="btn btn-rounded btn-info pull-right">{{__('Add New Saree Banner')}}</a>
                    </div>
                </div>
                    <br>
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{__('Saree banner')}}</h3>
                    </div>
                    <div class="panel-body">
                        <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
                            <thead>
...
<script type="text/javascript">
    ...
    function add_banner_3(){
        $.get('{{ route('mobile_banners.create',1)}}', {}, function(data){
    ...
    function add_banner_5(){
        $.get('{{ route('mobile_banners.create',3)}}', {}, function(data){
